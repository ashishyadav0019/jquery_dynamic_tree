...
return this.each(function() {
            ...
            if (animate_option[0] == true) {
                function animate_call_structure() {
                    console.log('animate_call_structure',3)
